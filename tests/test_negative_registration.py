from pages.auth import Registration, Authorization
from settings import generate_string_rus, generate_string_en, english_chars, chinese_chars, \
    russian_chars, special_symbols
from pages.locators import RegLocators, AuthLocators
from selenium.webdriver.common.by import By
from config import invalid_email, invalid_password, valid_phone, valid_email
import time
import pytest
...
@pytest.mark.parametrize('firstname', ['', generate_string_rus(1), generate_string_rus(31),
                                       ...
                                       special_symbols(), 11111],
                         ids=['empty', 'one char', '31 chars', '256 chars', 'english', 'chinese',
                              'special', 'number'])
def test_get_registration_invalid_firstname(browser, firstname):
...
@pytest.mark.reg
@pytest.mark.negatvie
@pytest.mark.parametrize('phone', ['', 1, 7111111111, generate_string_rus(11), special_symbols()],
